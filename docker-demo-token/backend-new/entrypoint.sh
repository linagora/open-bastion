...
echo "You must:"
echo "  1. Configure /etc/security/pam_llng.conf"
echo "  2. Configure /etc/nss_llng.conf"
echo "  3. Configure /etc/nsswitch.conf to use 'llng'"
echo "  4. Configure /etc/pam.d/sshd"
echo "  5. Enroll the server using llng-pam-enroll"
echo ""
