...
3. **PAM validation**: The `pam_openbastion.so` module validates the token with the portal
...
- **Bastion certificate vouching**: Backends require a valid bastion-vouched SSH certificate, preventing direct access even with valid user credentials
