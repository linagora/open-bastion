...
LemonLDAP::NG now supports RDP session recording through integration with `WALLIX Redemption <https://github.com/wallix/redemption>`_, an open-source RDP proxy from the French company Wallix.
...
See :doc:`RDP Feasibility Study </rdp-feasibility>` for detailed technical analysis.
