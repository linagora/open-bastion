...
- **Certificate vouching**: backend requires cryptographic proof of bastion origin
...
flowchart LR
    ...
    User["User"] -->|:80| SSO
    User -->|:2222| Bastion
    Bastion -->|SSH + vouched cert| Backend
...
- **Certificate vouching**: Backends require a bastion-vouched certificate
