...
echo "Bastion vouching: certificate (cert key-id allowlist + source-address)"
echo ""
echo "Direct SSH connections without a bastion-vouched certificate will be DENIED"
